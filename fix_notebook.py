...
for cell in cells:
    ...
    if 'start_llama_server' in src and 'dual GPU, 4 slots' in src:
        ...
        new_configs = (
            ...
            '    configs = [\n'
            '        {\n'
            '            "desc":    "dual GPU, 2 slots, ctx=118k, flash-attn off + SSM CPU",\n'
            '            "ngl":     999, "parallel": 2, "ctx": 118000, "batch": 256,\n'
            '            "flash":   "--flash-attn off",\n'
            '            "split":   f"--split-mode layer --tensor-split 0.5,0.5 {_SSM}",\n'
            '        },\n'
            '        {\n'
            '            "desc":    "dual GPU, 1 slot, ctx=118k, flash-attn off + SSM CPU",\n'
            '            "ngl":     999, "parallel": 1, "ctx": 118000, "batch": 128,\n'
            '            "flash":   "--flash-attn off",\n'
            '            "split":   f"--split-mode layer --tensor-split 0.5,0.5 {_SSM}",\n'
            '        },\n'
            '        {\n'
            '            "desc":    "dual GPU row-split, 1 slot, ctx=118k (no SSM fix, last resort)",\n'
            '            "ngl":     999, "parallel": 1, "ctx": 118000, "batch": 128,\n'
            '            "flash":   "--flash-attn off",\n'
            '            "split":   "--tensor-split 0.5,0.5",\n'
            '        },\n'
